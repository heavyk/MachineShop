...
out$.Fsm = Fsm = function(name, options){
  var debug, Fsm;
  ...
  Fsm = (function(){
    ...
    prototype.exec = function(inputType){
      var states, current, args, handlerName, handler, catchAll, obj;
      ...
      if (!this.inExitHandler) {
        ...
        return this.currentActionArgs = undefined;
      }
    };
    ...
    prototype.processQueue = function(type){
      ...
      return _.each(toProcess, function(item){
        return this.exec.apply(this, item.args);
      }, this);
    };
