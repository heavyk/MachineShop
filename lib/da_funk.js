...
var _, Path, regex_slash, regex_quote, regex_newline, regex_tab, regex_tabspace, regex_space, regex_newspace, res$, i$, i, _iindent, clean_str, stringify, da_funk_scopes, da_funk_callthrough, empty_scope, freedom, objectify, merge, improve, extend, formula, embody, out$ = typeof exports != 'undefined' && exports || this;
_ = require('lodash');
Path = require('path');
