var Fs, Path, Url, spawn, _, mkdirp, debug, nw_version, v8_version, HOME_DIR, v8_mode, Fiber, scan, parse, isDirectory, unquote, isQuoted, stripEscapeCodes, mkdir, exists, stat, readdir, readFile, writeFile, exec, searchDownwardFor, recursive_hardlink, Config, stringify, out$ = typeof exports != 'undefined' && exports || this;
Fs = require('fs');
Path = require('path');
Url = require('url');
